...
def spawn_turtle_fn():
    ...
    Index_Next_Turtle += 1
    new_turtle = mySpawner("turtle" + str(Index_Next_Turtle))
    Turtle_List.append(new_turtle)

    # Update existing turtles' behavior to avoid collision with the new turtle
    for turtle in Turtle_List:
        if turtle != new_turtle:
            turtle.update_target(new_turtle.turtle_name)
